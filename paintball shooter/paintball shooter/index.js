...
const scoreEl = document.querySelector('#scorePart')
const startGameEl = document.querySelector('#startGameBtn');
const gameStartSection = document.querySelector('#gameStartSection')
...
let player = new Player(x, y, 20, '#E0FFFF');
let projectiles = [];
let enemies = [];
let particles = [];

function init() {
    player = new Player(x, y, 20, '#E0FFFF');
    projectiles = [];
    enemies = [];
    particles = [];
    score = 0;
...
let score = 0
function animate() {
    animationId = requestAnimationFrame(animate)//for looping
